...
% Uso geral: Gerar sinal OFDM em banda-base para "N_carriers" subportadoras,
% sendo "N_pilots_target" delas, pilotos.
arguments(Input)
    symbols
    ...
    % Número de portadoras ativas (exclui guarda e DC).
    N_active_total = N_carriers - N_guard - 1;

    % Número de portadoras dedicadas a dados.
    N_data = N_active_total - N_pilots;
    
    % Organização dos dados em blocos
    ...
    % Pré-alocação e cálculo dos índices no Grid FFT
    ...
    % Insere pilotos com valor conhecido (1+0i).
