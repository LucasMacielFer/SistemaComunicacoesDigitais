...
% binários.
    arguments
        binseq (:,:) {mustBeNumeric, mustBeMember(binseq, [0, 1])}
        g1 (1,:) char 
        g2 (1,:) char 
    end
    ...
    for j = 1:num_seqs
        ...
        for i = 1:memo_size
            ...
            output(j, idx:idx+1) = [b1, b2]; % Preenche o resto da linha
            idx = idx + 2;
